...
export class AddGamificationAndPrizeSystem1767053199410 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_prize_redemptions_user_prize"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_prize_redemptions_prize_config_id"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_prize_redemptions_user_id"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "prize_redemptions"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_prize_configurations_is_active"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_prize_configurations_unique_active_tier"`);
        await queryRunner.query(`DROP TABLE IF EXISTS "prize_configurations"`);
        await queryRunner.query(`ALTER TABLE "wallets" DROP COLUMN IF EXISTS "lifetime_coins_earned"`);
    }
