...
export class AddPrizeRedemptionFeatures1767200000000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        // Drop indexes
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_prize_redemptions_user_tier_fulfilled"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_prize_redemptions_shipping_status"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_prize_redemptions_prize_tier"`);
