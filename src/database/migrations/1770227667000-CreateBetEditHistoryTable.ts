...
export class CreateBetEditHistoryTable1770227667000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        // Drop indexes first
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_bet_edit_history_round_edited"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_bet_edit_history_edited_at"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_bet_edit_history_stream_id"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "idx_bet_edit_history_bet_id"`);
        ...
        // Drop enum type
        await queryRunner.query(`DROP TYPE IF EXISTS "public"."bet_edit_type_enum"`);
    }
}
